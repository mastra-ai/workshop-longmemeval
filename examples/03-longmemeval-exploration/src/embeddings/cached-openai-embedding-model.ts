...
export class CachedOpenAIEmbeddingModel implements EmbeddingModelV1<string> {
  ...
  private readonly delegate: EmbeddingModelV1<string>;
  ...
  constructor(delegate: EmbeddingModelV1<string>, cacheDir: string = './embedding-cache') {
  ...
  > {
    ...
    if (uncachedValues.length > 0) {
      ...
      responseHeaders = result.rawResponse?.headers || {};
    } else {
